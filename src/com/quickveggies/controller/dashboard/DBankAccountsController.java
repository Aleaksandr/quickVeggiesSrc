            ...
            splitCol.setCellFactory(
                ...
                public TableCell<AccountEntryLine, String> call(TableColumn<AccountEntryLine, String> param) {
                    ...
                    button.setOnMouseClicked((MouseEvent event) -> {
                        ...
                        DashboardController.showPopup("/split_entry.fxml", "Split Entry", controller);
...
//                     tablesDisappear();
            ...
            edit.setOnAction(new EventHandler<ActionEvent>() {
                ...
                public void handle(ActionEvent event) {
                    ...
                    try {
                        FXMLLoader loader = new FXMLLoader(getClass().getResource("/bankadd.fxml"));
        ...
        upload.setOnAction(new EventHandler<ActionEvent>() {
            public void handle(ActionEvent event) {
                ...
                try {
                    Parent parent = FXMLLoader.load(getClass().getResource("/uploadxls.fxml"));
                    Scene scene = new Scene(parent);
                    scene.setOnKeyPressed(new EventHandler<KeyEvent>() {
                        public void handle(KeyEvent event) {
                            if (event.getCode() == KeyCode.ESCAPE) {
    ...
    private void populateAccountsView() {
        ...
        if (accountsNum > 0) {
            ...
            for (int i = 0; i < accountsNum; i++) {
                ...
                FXMLLoader loader = new FXMLLoader(getClass().getResource("/accountbox.fxml"));
