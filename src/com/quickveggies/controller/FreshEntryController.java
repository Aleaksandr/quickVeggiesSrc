...
public class FreshEntryController implements Initializable {
    ...
    public void initialize(final URL location, final ResourceBundle resources) {
        ...
        try {
            parent = FXMLLoader.load(getClass().getResource("/addcharges.fxml"));
        }
        catch (Exception e) {
            e.printStackTrace();
        }
        ...
        grower.linkToWindow(FreshEntryController.this, "/supplieradd.fxml", "Add new supplier", STR_ADD_NEW,
        ...
        fwAgent.linkToWindow(FreshEntryController.this, "/supplieradd.fxml", "Add new supplier", STR_ADD_NEW,
                new AddSupplierController());
 ...
 /*
    ...
    private AutoCompleteTextField createAutoCompleteBuyerTextField() {
        ...
        buyerSelectTextField.linkToWindow(FreshEntryController.this, "/buyeradd.fxml", "Add new buyer", STR_ADD_NEW,
